...
class StandardFlowRetrieveSessionTests: XCTestCase {
    override func setUp() {
    ...
    func testResponseSuccess() {
        let app = appLauncher().discoveryStub(respondsWith: "Discovery-success")
            ...
            .launch()
        let view = StandardFlowViewPageObject(app)
    ...
    private func fillUpFormWithValidValues(using view:StandardFlowViewPageObject) {
