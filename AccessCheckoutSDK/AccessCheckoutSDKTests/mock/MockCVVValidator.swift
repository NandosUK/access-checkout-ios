...
public class MockCVVValidator: CVVValidator, Cuckoo.ClassMock {
    
    public typealias MocksType = CVVValidator
    
    public typealias Stubbing = __StubbingProxy_CVVValidator
    public typealias Verification = __VerificationProxy_CVVValidator
    ...
    public func enableDefaultImplementation(_ stub: CVVValidator) {
    ...
    public override func validate(cvv: CVV?) -> ValidationResult {
    ...
    public override func validate(cvv: CVV, againstValidationRule validationRule: CardConfiguration.CardValidationRule) -> ValidationResult {
	...
	public struct __StubbingProxy_CVVValidator: Cuckoo.StubbingProxy {
	...
	public struct __VerificationProxy_CVVValidator: Cuckoo.VerificationProxy {
	    private let cuckoo_manager: Cuckoo.MockManager
...
public class CVVValidatorStub: CVVValidator {
